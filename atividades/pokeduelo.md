...
| ---- | ----------------------------- | ------------- | ------------- | --------------- | ----------------------------- | --------- | -------------------------------------------------------- |
| 1    | **Pikachu**                   | Elétrico      | **Gyarados**  | Água/Voador     | Pikachu vence                 | Clássico  | Elétrico é 4x eficaz contra Água/Voador                  |
| 2    | **Charizard**                 | Fogo/Voador   | **Blastoise** | Água            | Charizard perde               | Clássico  | Água é forte contra Fogo                                 |
| 3    | **Venusaur**                  | Planta/Veneno | **Charizard** | Fogo/Voador     | Venusaur perde                | Clássico  | Fogo é forte contra Planta                               |
| 4    | **Machamp**                   | Lutador       | **Alakazam**  | Psíquico        | Machamp perde                 | Clássico  | Psíquico é forte contra Lutador                          |
| 5    | **Golem**                     | Pedra/Terra   | **Blastoise** | Água            | Golem perde                   | Clássico  | Água é forte contra Terra/Pedra                          |
| 6    | **Scyther**                   | Inseto/Voador | **Charizard** | Fogo/Voador     | Scyther perde                 | Clássico  | Fogo é forte contra Inseto                               |
| 7    | **Jigglypuff**                | Normal/Fada   | **Gengar**    | Fantasma/Veneno | Jigglypuff perde              | Clássico  | Fantasma imune a Normal, forte contra Fada               |
| 8    | **Electabuzz**                | Elétrico      | **Rhydon**    | Terra/Pedra     | Electabuzz perde (sem efeito) | Clássico  | Elétrico não afeta tipo Terra                            |
| 9    | **Magikarp**                  | Água          | **Machamp**   | Lutador         | Magikarp perde                | Absurdo   | Magikarp é notoriamente fraco                            |
| 10   | **Caterpie**                  | Inseto        | **Arcanine**  | Fogo            | Caterpie perde                | Absurdo   | Inseto fraco contra Fogo, Caterpie tem stats baixíssimos |
| 11   | **Farfetch’d**                | Normal/Voador | **Zapdos**    | Elétrico/Voador | Farfetch’d perde              | Absurdo   | Diferença massiva de stats e fama                        |
| 12   | **Ditto** (sem transformação) | Normal        | **Dragonite** | Dragão/Voador   | Ditto perde (na prática)      | Absurdo   | Ditto precisa de transformação para lutar bem            |
| 13   | **Metapod**                   | Inseto        | **Charizard** | Fogo/Voador     | Metapod perde                 | Absurdo   | Metapod só usa Harden, fraco vs Fogo                     |
| 14   | **Snorlax**                   | Normal        | **Hitmonlee** | Lutador         | Snorlax perde                 | Clássico  | Lutador é eficaz contra Normal                           |
| 15   | **Dragonite**                 | Dragão/Voador | **Articuno**  | Gelo/Voador     | Dragonite perde               | Clássico  | Gelo é 4x eficaz contra Dragão/Voador                    |

**Vamos usar os Pokémon do 152 pra frente para TREINO e vou testar só com a Geração 1**
